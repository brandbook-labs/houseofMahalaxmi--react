    ...
    <section ref={containerRef} className="bg-[#080808] text-white py-24 lg:py-32 px-6 border-t border-white/10 selection:bg-[#34d0d0] selection:text-black">
      <div className="max-w-[1400px] mx-auto">
        ...
        <div ref={titleRef} className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
          <div>
            <span className="text-[#34d0d0] font-mono text-sm uppercase tracking-widest mb-4 block">• Leadership</span>
            ...
            <div key={index} className="leader-card group relative cursor-pointer">
              ...
              <div className="relative w-full aspect-[3/4] overflow-hidden rounded-lg bg-[#111] mb-6">
                ...
                <div className="absolute bottom-0 left-0 w-full p-6 flex items-center gap-4 translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-[cubic-bezier(0.2,0.8,0.2,1)]">
                   <a href={leader.linkedin} className="w-10 h-10 bg-white text-black rounded-full flex items-center justify-center hover:bg-[#34d0d0] transition-colors">
                      <Linkedin size={18} />
                   </a>
                   <a href={leader.twitter} className="w-10 h-10 bg-white text-black rounded-full flex items-center justify-center hover:bg-[#34d0d0] transition-colors">
                      <Twitter size={18} />
                   </a>
                </div>
              </div>
              ...
              <div className="flex justify-between items-start border-b border-white/10 pb-4 group-hover:border-white/40 transition-colors duration-500">
                <div>
                  <h3 className="text-xl font-bold uppercase tracking-wide mb-1 group-hover:text-[#34d0d0] transition-colors">
                    {leader.name}
                  </h3>
                ...
                {/* Arrow Icon */}
                <div className="text-white/30 group-hover:text-[#34d0d0] group-hover:-translate-y-1 group-hover:translate-x-1 transition-all duration-300">
